...
- (void)awakeFromNib {
    ...
    //UITextViewTextDidBeginEditingNotification
     [MPNotificationCenter addObserver:self selector:@selector(textViewBeginNoti:) name:UITextViewTextDidBeginEditingNotification object:self];
    
    //UITextViewTextDidEndEditingNotification
    
    [MPNotificationCenter addObserver:self selector:@selector(textViewEndNoti:) name:UITextViewTextDidEndEditingNotification object:self];
...
- (void)setNumLine0:(BOOL)numLine0
{
    _numLine0 = numLine0;
}
#pragma mark---一些通知
